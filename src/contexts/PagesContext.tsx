...
export function PagesContextProvider(props: PagesContextProviderType) {
    ...
    const prairieKing = useState<PagesProps>(defaultClosePage)
    ...
    const updateState = (props: any) => {
        ...
        prairieKing[1]({ ...prairieKing[0], ...props })
    };

    return (
        <PagesContext.Provider value={{
            startMenu, openMenu,
            welcome, aboutMe, training, credits, musicPlayer, skills, paint, minecraft, prairieKing,
